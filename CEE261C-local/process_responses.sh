...
for Y_DISTANCE in "${Y_PLANES_ARRAY[@]}"; do
    WRITE_IMAGE_COMMANDS="$WRITE_IMAGE_COMMANDS
WRITE_IMAGE NAME= ./IMAGES/SIDE_STD_UMAG_Y_${Y_DISTANCE} INTERVAL=10000 TARGET 0 0 50 CAMERA 0 -559 50 UP 0 0 1 SIZE 1512 860 WIDTH 300 GEOM PLANE 0 ${Y_DISTANCE} 0 0 1 0 VAR rms(mag(u)) RANGE 0 15.3 COLORMAP GRAYSCALE_RGB HIDE_ZONES_NAMED Y0"
done
