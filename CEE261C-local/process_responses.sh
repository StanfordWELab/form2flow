...
for Y_DISTANCE in "${Y_PLANES_ARRAY[@]}"; do
    WRITE_IMAGE_COMMANDS="$WRITE_IMAGE_COMMANDS
WRITE_IMAGE NAME= ./IMAGES/TOP_AVG_UMAG_Y_${Y_DISTANCE} INTERVAL=100 5.5 0 57 CAMERA 5.5 559 57 UP 0 0 1 SIZE 1920 970 WIDTH 321 GEOM PLANE 0 ${Y_DISTANCE} 0 0 -1 0 VAR avg(mag(u)) RANGE 0 15.3 COLORMAP GRAYSCALE_RGB HIDE_ZONES_NAMED Y1"
done
